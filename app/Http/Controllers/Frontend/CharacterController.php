...
class CharacterController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.characters.create', compact('age_groups', 'body_types', 'dress_styles', 'emotions', 'eye_colors', 'eye_shapes', 'facial_expressions', 'genders', 'hair_colors', 'hair_lenghts', 'hair_styles', 'scenes', 'skin_tones', 'users'));
    }
    ...
    public function edit(Character $character)
    {
        ...
        return view('frontend.characters.edit', compact('age_groups', 'body_types', 'character', 'dress_styles', 'emotions', 'eye_colors', 'eye_shapes', 'facial_expressions', 'genders', 'hair_colors', 'hair_lenghts', 'hair_styles', 'scenes', 'skin_tones', 'users'));
    }
