...
class HomeController
{
    public function index()
    {
        ...
        $settings3 = [
            'chart_title'           => 'Characters Generated',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        return view('home', compact('chart1', 'settings2', 'settings3', 'settings4', 'settings5', 'settings6'));
    }
}
