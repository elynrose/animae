...
class TasksController extends Controller
{
    ...
    public function index()
    {
        ...
        $tasks = Task::with(['character', 'user'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.tasks.create', compact('characters', 'users'));
    }
    ...
    public function edit(Task $task)
    {
        ...
        $task->load('character', 'user');

        return view('admin.tasks.edit', compact('characters', 'task', 'users'));
    }
