<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('character_setting_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/age-groups*") ? "c-show" : "" }} {{ request()->is("admin/genders*") ? "c-show" : "" }} {{ request()->is("admin/body-types*") ? "c-show" : "" }} {{ request()->is("admin/hair-colors*") ? "c-show" : "" }} {{ request()->is("admin/hair-lengths*") ? "c-show" : "" }} {{ request()->is("admin/hair-styles*") ? "c-show" : "" }} {{ request()->is("admin/eye-colors*") ? "c-show" : "" }} {{ request()->is("admin/eye-shapes*") ? "c-show" : "" }} {{ request()->is("admin/skin-tones*") ? "c-show" : "" }} {{ request()->is("admin/facial-expressions*") ? "c-show" : "" }} {{ request()->is("admin/dress-styles*") ? "c-show" : "" }} {{ request()->is("admin/emotions*") ? "c-show" : "" }} {{ request()->is("admin/backgrounds*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
        ...
        @endcan
        @can('character_role_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.character-roles.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/character-roles") || request()->is("admin/character-roles/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-user-friends c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.characterRole.title') }}
                </a>
            </li>
        @endcan
        @can('task_access')
