    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.characters.update", [$character->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('body_type') ? 'is-invalid' : '' }}" name="body_type_id" id="body_type_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('hair_color') ? 'is-invalid' : '' }}" name="hair_color_id" id="hair_color_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('hair_lenght') ? 'is-invalid' : '' }}" name="hair_lenght_id" id="hair_lenght_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('hair_style') ? 'is-invalid' : '' }}" name="hair_style_id" id="hair_style_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('eye_color') ? 'is-invalid' : '' }}" name="eye_color_id" id="eye_color_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('eye_shape') ? 'is-invalid' : '' }}" name="eye_shape_id" id="eye_shape_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('skin_tone') ? 'is-invalid' : '' }}" name="skin_tone_id" id="skin_tone_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('facial_expression') ? 'is-invalid' : '' }}" name="facial_expression_id" id="facial_expression_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('emotion') ? 'is-invalid' : '' }}" name="emotion_id" id="emotion_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dress_style') ? 'is-invalid' : '' }}" name="dress_style_id" id="dress_style_id" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('background') ? 'is-invalid' : '' }}" name="background" id="background">{!! old('background', $character->background) !!}</textarea>
